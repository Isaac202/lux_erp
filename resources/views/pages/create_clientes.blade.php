@extends('layouts.app', ['activePage' => 'table', 'titlePage' => __('Cadastrar cliente')])
...
<div class="content">
  <div class="container-fluid">
    ...
    <input type="email"  required="required" name="email" class="form-control" placeholder="E-mail" aria-describedby="basic-addon1">
    </div>
    <div class="form-group">
...
$(function() {
    ...
    $('#formReg').submit(function(event) {
    	...
    	$.post("{{route('clientes')}}",dados, function( data )	{
